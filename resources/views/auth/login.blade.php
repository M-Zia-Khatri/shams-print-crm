...
<body class="min-h-screen bg-base-200 text-base-content antialiased transition-colors duration-200">
    ...
    <div class="absolute top-4 right-4 z-50">
        <button id="theme-toggle"
            class="btn btn-ghost btn-circle bg-base-100/50 backdrop-blur border border-base-300 shadow-sm"
            aria-label="Toggle Theme">
            <!-- Sun icon (shows in dark mode) -->
            <svg id="theme-sun" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
    ...
    <main class="grid min-h-screen grid-cols-1 lg:grid-cols-12">
        ...
        <div
            class="lg:col-span-5 hidden lg:flex flex-col justify-between p-12 bg-neutral text-neutral-content relative overflow-hidden">
            <!-- Decorative Radial Background Glows -->
            <div
                class="absolute -top-40 -left-45 w-[500px] h-[500px] rounded-full bg-primary/10 blur-[120px] pointer-events-none">
            </div>
            <div
                class="absolute -bottom-40 -right-45 w-[500px] h-[500px] rounded-full bg-secondary/15 blur-[120px] pointer-events-none">
            </div>
            ...
            <div class="my-auto max-w-sm z-10 space-y-6">
                ...
                <p class="text-sm text-neutral-content/85 leading-relaxed font-light">
                    Track orders, dispatch quotations, update invoices, and monitor inventory items through one unified
                    platform.
                </p>
                ...
                <ul class="space-y-4">
                    <li class="flex items-start gap-3">
                        <span
                            class="p-1 bg-emerald-500/10 text-emerald-400 rounded-md shrink-0 mt-0.5 border border-emerald-500/20">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-neutral-content/65 leading-normal mt-0.5">Track every interaction,
                                quotation and ledger in one view.</p>
                        </div>
                    </li>
                    <li class="flex items-start gap-3">
                        <span
                            class="p-1 bg-indigo-500/10 text-indigo-400 rounded-md shrink-0 mt-0.5 border border-indigo-500/20">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="2.5" stroke="currentColor" class="w-3.5 h-3.5">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                            </svg>
                        ...
                        <div>
                            ...
                            <p class="text-xs text-neutral-content/65 leading-normal mt-0.5">Generate estimates and
                                convert them into active invoices with one flag.</p>
                        </div>
                    </li>
                </ul>
            </div>
            ...
            <div class="text-xs text-neutral-content/40 z-10 font-normal">
                &copy; {{ date('Y') }} Shams Print CRM. All rights reserved. Made by Muhammad Zia Khatri.
            </div>
        </div>
        ...
        <div class="lg:col-span-7 flex flex-col justify-center items-center p-6 sm:p-12 relative">
            ...
            <div
                class="absolute top-10 right-10 w-[250px] h-[250px] rounded-full bg-primary/5 blur-[80px] pointer-events-none lg:hidden animate-pulse">
            </div>
                ...
                <div class="card w-full bg-base-100 shadow-xl border border-base-300 rounded-2xl">
                    <div class="card-body p-8">
                        ...
                        <div class="hidden lg:block mb-8">
                            ...
                            <p class="text-sm text-base-content/60 mt-1 font-light leading-relaxed">Enter your system
                                credentials below to access your workspace dashboard.</p>
                        </div>
                        ...
                        @if ($errors->any())
                            <div class="alert alert-error mb-6 shadow-sm rounded-xl py-3 px-4 flex items-start gap-3">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="stroke-current shrink-0 h-5 w-5 mt-0.5 text-error-content" fill="none"
                                    viewBox="0 0 24 24">
                        ...
                        <form method="POST" action="{{ route('login.store') }}" id="login-form">
                            ...
                            <div class="form-control w-full mb-4">
                                <label class="label pb-1.5" for="name">
                                    <span
                                        class="label-text font-bold text-base-content/80 text-xs uppercase tracking-wider">Username
                                        / Name</span>
                                </label>
                                <div class="relative">
                                    <span
                                        class="absolute inset-y-0 left-0 flex items-center pl-3.5 text-base-content/40 pointer-events-none">
                                        <!-- User SVGIcon -->
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    ...
                                    <input id="name" type="text" name="name" value="{{ old('name') }}"
                                        ...
                                        class="input input-bordered w-full pl-11 rounded-xl @error('name') input-error @enderror"
                                        required autofocus>
                                </div>
                            </div>
                            ...
                            <div class="form-control w-full mb-4">
                                <label class="label pb-1.5" for="password">
                                    <span
                                        class="label-text font-bold text-base-content/80 text-xs uppercase tracking-wider">Password</span>
                                </label>
                                <div class="relative">
                                    <span
                                        class="absolute inset-y-0 left-0 flex items-center pl-3.5 text-base-content/40 pointer-events-none">
                                    ...
                                    <input id="password" type="password" name="password" placeholder="••••••••"
                                        class="input input-bordered w-full pl-11 pr-11 rounded-xl @error('password') input-error @enderror"
                                        required>
                                    <button type="button" onclick="togglePasswordVisibility()"
                                        class="absolute inset-y-0 right-0 flex items-center pr-3.5 text-base-content/45 hover:text-base-content transition-colors"
                                        aria-label="Toggle Password Visibility">

                                        <x-eva-eye-outline id="eye-show" />
                                        <x-eva-eye-off-outline id="eye-hide" />
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="form-control w-full mb-4">
                                <label class="label pb-1.5" for="role">
                                    <span
                                        class="label-text font-bold text-base-content/80 text-xs uppercase tracking-wider">User
                                        Role</span>
                                </label>
                                <div class="relative">
                                    <span
                                        class="absolute inset-y-0 left-0 flex items-center pl-3.5 text-base-content/40 pointer-events-none z-10 animate-fade">
                                        <!-- Shield SVGIcon -->
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                    ...
                                    <select id="role" name="role"
                                        class="select select-bordered w-full pl-11 rounded-xl @error('role') select-error @enderror"
                                        required>
                                        <option value="super_admin" @selected(old('role', 'super_admin') === 'super_admin')>Super Admin</option>
                                        <option value="admin" @selected(old('role', 'super_admin') === 'admin')>Admin</option>
                                        <option value="viewer" @selected(old('role', 'super_admin') === 'viewer')>Viewer</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-control mt-6">
                                <button type="submit" id="submit-btn"
                                    class="btn btn-primary w-full text-base font-bold shadow-md hover:shadow-lg rounded-xl transition-all duration-200 gap-2">
