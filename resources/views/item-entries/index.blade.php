<x-app-layout>
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <x-section-title title="Item Entries"
            subtitle="Manage lart entries, party details, images, rates, and computed totals." />
                                        ...
                                        <div class="flex justify-end gap-2">
                                            ...
                                            <form method="POST"
                                                ...
                                                <x-action-button type="submit" variant="error"
                                                    size="sm">Delete</x-action-button>
                                            </form>
                                        </div>
                                    </td>
                                @endif
