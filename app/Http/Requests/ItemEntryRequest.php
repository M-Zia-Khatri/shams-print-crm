    ...
    public function rules(): array
    {
        if ($this->isMethod('post')) {
            return [
                ...
                'entries.*.image' => ['required', 'image', 'mimes:jpg,jpeg,png,webp', 'max:5120'],
        ...
        return [
            ...
            'image' => [($this->isMethod('put') || $this->isMethod('patch')) ? 'nullable' : 'required', 'image', 'mimes:jpg,jpeg,png,webp', 'max:5120'],
